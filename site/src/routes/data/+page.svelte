	...
	<div class="flex flex-col h-full w-full max-w-2xl">
		...
		<div class="card p-2 mt-2">
			...
			<p id="link-description" class="">
				To connect to your local websocket server (in Unity, Unreal, etc.) Please enter the host url
				and port.
			</p>
			<div class="flex gap-2 flex-wrap lg:flex-nowrap mt-2">
				...
				/>
				<button class="btn variant-filled-secondary btn-base" on:click={setWebsocket}
					>Connect</button
				>
			</div>
